...
export declare class Thing implements IThing {
    ...
    constructor(id: string, name: string, storageLocation: Location, cost: IBorrowCost, currentStatus: ThingStatus, description: string, imageUrls: string[], owner: ILender | null, insuredAmount: Money | null, requiredBorrowerFlags?: BorrowerVerificationFlags[]);
